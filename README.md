...
flowchart TB
    ...
    subgraph SIM["simglucose Simulator"]
        P["T1D Patient<br/>+ Realistic Meal Scenario"]
    end
    ...
    subgraph PIPE["Decision Pipeline"]
        SM["State Manager<br/>[glucose, RoC, IOB, body_weight]"]
        SL["Safety Layer<br/>(cohort-aware rules)"]
    end
    ...
    %% Simulator
    classDef sim fill:#172554,stroke:#60A5FA,stroke-width:3px,color:#EFF6FF;

    %% RL Agents
    classDef agent fill:#064E3B,stroke:#34D399,stroke-width:3px,color:#ECFDF5;

    %% Meta Controller
    classDef meta fill:#4C1D95,stroke:#A78BFA,stroke-width:3px,color:#F5F3FF;

    %% Pipeline
    classDef pipe fill:#1E3A8A,stroke:#818CF8,stroke-width:3px,color:#EEF2FF;
    ...
    linkStyle 0 stroke:#34D399,stroke-width:3px;
    linkStyle 1 stroke:#34D399,stroke-width:3px;
    linkStyle 2 stroke:#60A5FA,stroke-width:3px;
    linkStyle 3 stroke:#A78BFA,stroke-width:3px;
    linkStyle 4 stroke:#818CF8,stroke-width:3px;
    linkStyle 5 stroke:#F472B6,stroke-width:3px;
```
---
